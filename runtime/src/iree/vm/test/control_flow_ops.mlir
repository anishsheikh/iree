vm.module @control_flow_ops {
  ...
  // TODO(simon-camp): support vm.br_table in emitc.
  vm.export @test_br_table_inbounds attributes {emitc.exclude}
  ...
  ^bb2(%arg1: i32):
    vm.check.eq %arg1, %c2, "expected table[1] branch" : i32
    vm.return
  }

  // TODO(simon-camp): support vm.br_table in emitc.
  vm.export @test_br_table_outofbounds attributes {emitc.exclude}
